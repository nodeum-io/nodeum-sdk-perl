...
#
package Nodeum::SDK::TaskCallbacksApi;
...
# @param TaskCallback $task_callback_body  (required)
{
    ...
    'task_callback_body' => {
        data_type => 'TaskCallback',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'create_task_callback' } = { 
        summary => 'Creates a new task callback.',
        params => $params,
        returns => 'TaskCallback',
        };
}
# @return TaskCallback
#
sub create_task_callback {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling create_task_callback");
    }

    # verify the required parameter 'task_callback_body' is set
    unless (exists $args{'task_callback_body'}) {
      croak("Missing the required parameter 'task_callback_body' when calling create_task_callback");
    }

    # parse inputs
    my $_resource_path = '/tasks/{task_id}/task_callbacks';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'task_callback_body'}) {
        $_body_data = $args{'task_callback_body'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('TaskCallback', $response);
...
# @param int $task_callback_id Numeric ID of task callback. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'destroy_task_callback' } = { 
...
# @return void
#
sub destroy_task_callback {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling destroy_task_callback");
    }

    # verify the required parameter 'task_callback_id' is set
    unless (exists $args{'task_callback_id'}) {
      croak("Missing the required parameter 'task_callback_id' when calling destroy_task_callback");
    }

    # parse inputs
    my $_resource_path = '/tasks/{task_id}/task_callbacks/{task_callback_id}';
    ...
    # path params
    if ( exists $args{'task_callback_id'}) {
        my $_base_variable = "{" . "task_callback_id" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'task_callback_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $script Filter on task callback script (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'index_task_callbacks' } = { 
        summary => 'Lists all task callbacks.',
        params => $params,
        returns => 'TaskCallbackCollection',
        };
}
# @return TaskCallbackCollection
#
sub index_task_callbacks {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling index_task_callbacks");
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('TaskCallbackCollection', $response);
    return $_response_object;
}
...
# @param int $task_callback_id Numeric ID of task callback. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'show_task_callback' } = { 
...
# @return TaskCallback
#
sub show_task_callback {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling show_task_callback");
    }

    # verify the required parameter 'task_callback_id' is set
    unless (exists $args{'task_callback_id'}) {
      croak("Missing the required parameter 'task_callback_id' when calling show_task_callback");
    }
...
# @param TaskCallback $task_callback_body  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_task_callback' } = { 
...
# @return TaskCallback
#
sub update_task_callback {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling update_task_callback");
    }

    # verify the required parameter 'task_callback_id' is set
    unless (exists $args{'task_callback_id'}) {
      croak("Missing the required parameter 'task_callback_id' when calling update_task_callback");
    }

    # verify the required parameter 'task_callback_body' is set
    unless (exists $args{'task_callback_body'}) {
      croak("Missing the required parameter 'task_callback_body' when calling update_task_callback");
    }
