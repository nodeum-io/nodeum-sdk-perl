...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'Nodeum::SDK::Configuration' ) {
        $config = $_[0];
    } else {
        $config = Nodeum::SDK::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("Nodeum::SDK::Object::$class")->new;
        if (ref $data eq "HASH") {
