...
#
package Nodeum::SDK::Object::Container;
...
__PACKAGE__->method_documentation({
    ...
    'only_on_cache_file_count' => {
        datatype => 'int',
        base_name => 'only_on_cache_file_count',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'only_on_cache_file_size_sum' => {
        datatype => 'int',
        base_name => 'only_on_cache_file_size_sum',
        description => '',
        format => '',
        read_only => '',
            },
