...
#
package Nodeum::SDK::Object::ByMetadataKeyBucket;
...
__PACKAGE__->method_documentation({
    ...
    'more_2_years' => {
        datatype => 'FileFacet',
        base_name => 'more_2_years',
        description => '',
        format => '',
        read_only => '',
            },
    'meta_value_t' => {
        datatype => 'ByMetadataValueBuckets',
