...
#
package Nodeum::SDK::Object::BySizeFacet;
...
__PACKAGE__->method_documentation({
    ...
    'less_100_kb' => {
        datatype => 'ByDateFacet',
        base_name => 'less_100_kb',
        description => '',
        format => '',
        read_only => '',
            },
