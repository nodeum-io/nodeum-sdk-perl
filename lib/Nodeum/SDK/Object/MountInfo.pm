...
#
package Nodeum::SDK::Object::MountInfo;
...
__PACKAGE__->method_documentation({
    ...
    'cloud_connector_name' => {
        datatype => 'string',
        base_name => 'cloud_connector_name',
        description => '',
        format => '',
        read_only => '',
            },
