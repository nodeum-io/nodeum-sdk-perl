...
#
package Nodeum::SDK::Object::TaskFacetMetadataKeyBucket;
...
__PACKAGE__->method_documentation({
    ...
    'processed_size_sum' => {
        datatype => 'int',
        base_name => 'processed_size_sum',
        description => '',
        format => '',
        read_only => '',
            },
    'to_process_files_sum' => {
        datatype => 'int',
        base_name => 'to_process_files_sum',
        description => '',
        format => '',
        read_only => '',
            },
    ...
    'meta_value_t' => {
        datatype => 'TaskFacetMetadataValueBuckets',
        base_name => 'meta_value_t',
        description => '',
        format => '',
        read_only => '',
            },
