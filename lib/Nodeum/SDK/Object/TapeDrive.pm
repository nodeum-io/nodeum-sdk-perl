...
#
package Nodeum::SDK::Object::TapeDrive;
...
__PACKAGE__->method_documentation({
    ...
    'use_file_processed_size' => {
        datatype => 'int',
        base_name => 'use_file_processed_size',
        description => '',
        format => '',
        read_only => '',
            },
    'use_file_size_to_process' => {
        datatype => 'int',
        base_name => 'use_file_size_to_process',
        description => '',
        format => '',
        read_only => '',
            },
    'use_file_name_processed' => {
        datatype => 'string',
        base_name => 'use_file_name_processed',
        description => '',
        format => '',
        read_only => '',
            },
