...
# 
{
    ...
    __PACKAGE__->method_documentation->{ 'index_mounts' } = { 
        summary => 'List all mounted storages.',
        params => $params,
        returns => 'MountCollection',
        };
}
...
sub index_mounts {
    ...
    my $_response_object = $self->{api_client}->deserialize('MountCollection', $response);
