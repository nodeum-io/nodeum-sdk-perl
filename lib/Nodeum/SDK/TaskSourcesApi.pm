...
#
package Nodeum::SDK::TaskSourcesApi;
...
# @param TaskSourceUp $task_source_body  (required)
{
    ...
    'task_source_body' => {
        data_type => 'TaskSourceUp',
        description => '',
        required => '1',
    },
    };
    __PACKAGE__->method_documentation->{ 'create_task_source' } = { 
        summary => 'Creates a new task source.',
        params => $params,
        returns => 'TaskSourceDown',
        };
}
# @return TaskSourceDown
#
sub create_task_source {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling create_task_source");
    }

    # verify the required parameter 'task_source_body' is set
    unless (exists $args{'task_source_body'}) {
      croak("Missing the required parameter 'task_source_body' when calling create_task_source");
    }

    # parse inputs
    my $_resource_path = '/tasks/{task_id}/task_sources';
    ...
    my $_body_data;
    # body params
    if ( exists $args{'task_source_body'}) {
        $_body_data = $args{'task_source_body'};
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('TaskSourceDown', $response);
...
# @param int $task_source_id Numeric ID of task source. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'destroy_task_source' } = { 
...
# @return void
#
sub destroy_task_source {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling destroy_task_source");
    }

    # verify the required parameter 'task_source_id' is set
    unless (exists $args{'task_source_id'}) {
      croak("Missing the required parameter 'task_source_id' when calling destroy_task_source");
    }

    # parse inputs
    my $_resource_path = '/tasks/{task_id}/task_sources/{task_source_id}';
    ...
    # path params
    if ( exists $args{'task_source_id'}) {
        my $_base_variable = "{" . "task_source_id" . "}";
        my $_base_value = $self->{api_client}->to_path_value($args{'task_source_id'});
        $_resource_path =~ s/$_base_variable/$_base_value/g;
    }
...
# @param string $pool_id Filter on a pool id (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'index_task_sources' } = { 
        summary => 'Lists all task sources.',
        params => $params,
        returns => 'TaskSourceCollection',
        };
}
# @return TaskSourceCollection
#
sub index_task_sources {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling index_task_sources");
    }
    ...
    # query params
    if ( exists $args{'import_file_id'}) {
        $query_params->{'import_file_id'} = $self->{api_client}->to_query_value($args{'import_file_id'});
    }
    ...
    my $_response_object = $self->{api_client}->deserialize('TaskSourceCollection', $response);
    return $_response_object;
}
...
# @param int $task_source_id Numeric ID of task source. (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'show_task_source' } = { 
...
# @return TaskSourceDown
#
sub show_task_source {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling show_task_source");
    }

    # verify the required parameter 'task_source_id' is set
    unless (exists $args{'task_source_id'}) {
      croak("Missing the required parameter 'task_source_id' when calling show_task_source");
    }
...
# @param TaskSourceUp $task_source_body  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'update_task_source' } = { 
...
# @return TaskSourceDown
#
sub update_task_source {
    my ($self, %args) = @_;

    # verify the required parameter 'task_id' is set
    unless (exists $args{'task_id'}) {
      croak("Missing the required parameter 'task_id' when calling update_task_source");
    }

    # verify the required parameter 'task_source_id' is set
    unless (exists $args{'task_source_id'}) {
      croak("Missing the required parameter 'task_source_id' when calling update_task_source");
    }

    # verify the required parameter 'task_source_body' is set
    unless (exists $args{'task_source_body'}) {
      croak("Missing the required parameter 'task_source_body' when calling update_task_source");
    }
